...
LSM:Register("statusbar","RUI Dark Blue", [[Interface\AddOns\RebornUI\media\textures\statusBars\darkBlueGradient.tga]]);
LSM:Register("statusbar","RUI Gray", [[Interface\AddOns\RebornUI\media\textures\statusBars\grayGradient.tga]]);